...
<script type="text/javascript">
	...
	function postCheck(post){
		...
		var url = "${ pageContext.request.contextPath }/member/postCheck.do?post="+post;
...
<body>
	...
	<section>
		<form name = "inputForm" onsubmit = "return checkForm()" action = "${ pageContext.request.contextPath }/memberproc.do">
	<div align="center">
		<h2>회원 가입</h2>
		<hr width="80%" />
		<br />
