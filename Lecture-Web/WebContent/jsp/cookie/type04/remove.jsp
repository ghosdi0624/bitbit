...
<%
	...
	Cookie c3 = new Cookie("type03",URLEncoder.encode("Lecture-Web/jsp/cookie/type03루트설정","utf-8"));
	c3.setPath("/Lecture-Web/jsp/cookie/type03");
	c3.setMaxAge(0);
	
	Cookie c4 = new Cookie("type04",URLEncoder.encode("Lecture-Web/jsp/cookie/type04루트설정","utf-8"));
