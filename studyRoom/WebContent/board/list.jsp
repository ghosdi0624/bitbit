		...
		<h2>질문 게시판</h2>
			<table class="table table-striped">
				...
				<c:forEach var="notice" items="${noticelist }">
					<tr>
						<td bgcolor="#ffc8c8"><c:out value="${notice.no }" /></td>
						<td bgcolor="#ffc8c8"><a
							href="${pageContext.request.contextPath}/detail.do?no=${notice.no }"><c:out
									value="${notice.title }" /></a></td>
						<td bgcolor="#ffc8c8"><c:out value="${notice.writer }" /></td>
						<td bgcolor="#ffc8c8"><c:out value="${notice.regDate }" /></td>
						<td bgcolor="#ffc8c8"><c:out value="${notice.viewCnt }" /></td>
					</tr>
				</c:forEach>
