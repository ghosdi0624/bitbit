...
<body>
	...
	<%
		...
		ResultSet rs = stat.executeQuery("SELECT borno,title,reading,hit FROM border1 where borno = " + no);
		rs.next();
	...
	<%
		rs = stat.executeQuery("update border1 set hit = "+hit+"where borno = "+no);
	%>
</body>
</html>