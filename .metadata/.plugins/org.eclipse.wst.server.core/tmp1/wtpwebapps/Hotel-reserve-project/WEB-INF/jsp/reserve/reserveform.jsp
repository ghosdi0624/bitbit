...
<body>
	...
	<form name="inputform">
		...
		<table style="float:center; bgcolor:#ff22cc">
			...
			<!-- 일요일 ~ 토요일 -->
	 		<tr height="25">
				<td width="120" bgcolor="pink" align="center"><font color="red">일</font></td>
				<td width="120" bgcolor="#c8c8c8" align="center">월</td>
				<td width="120" bgcolor="#c8c8c8" align="center">화</td>
				<td width="120" bgcolor="#c8c8c8" align="center">수</td>
				<td width="120" bgcolor="#c8c8c8" align="center">목</td>
				<td width="120" bgcolor="#c8c8c8" align="center">금</td>
				<td width="120" bgcolor="lightblue" align="center"><font color="blue">토</font></td>
			</tr> 
